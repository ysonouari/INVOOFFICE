...
export function addLine(data){
  ...
  tr.id = id;
  tr.innerHTML = `
    <td><input type="text" class="line-desig" aria-label="${i18next.t('form.line_designation')}" placeholder="${i18next.t('form.line_placeholder')}" value="${data && data.desig ? escapeHtml(data.desig) : ''}"></td>
    <td class="col-prix"><input type="number" class="line-prix" aria-label="${i18next.t('form.line_price')}" value="${data ? data.prix : 0}" step="0.01" min="0"></td>
    <td class="col-qte"><input type="number" class="line-qte" aria-label="${i18next.t('form.line_qty')}" value="${data ? data.qte : 1}" step="1" min="0"></td>
